...
# 3
 ...
 #           color_pixel = resized[y, x] #resized is a tuple of 3 elements, h x w x 3
...
# 7
    ...
    sobel_filter_1 = cv2.filter2D(blur, -1, sobel_vertical) #-1 is depth of image
...
# 8
    ...
    # maxval sets the maxvalue the pixel will get (white) and last paramter sets a functin 0/max
